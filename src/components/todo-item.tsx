  ...
  return (
    <div className="flex flex-nowrap items-center border rounded h-12 p-2 gap-2 bg-white shadow">
      <button
        ...
        <span className="block size-3 rounded-full group-aria-checked:bg-indigo-600"> </span>
      </button>
...
function EditTodoItem({ id, content, setEditing }: TodoItemProps) {
  ...
  return (
    <form
      ...
      <input type="text" name="content" defaultValue={content} autoFocus className="h-full p-2 rounded grow" />
